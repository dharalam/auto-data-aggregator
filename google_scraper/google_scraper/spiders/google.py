...
class GoogleSpider(scrapy.Spider):
    ...
    def __init__(self, queries=None, *args, **kwargs):
        ...
        if queries != None:
            self.queries = [i for i in queries.split("/")]
        else:
            self.queries = ['asana+reviews', 'clickup+reviews', 'best+project+management+software', 'best+project+management+software+for+small+teams']
